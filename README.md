...
* [x] Created a work-around for the bug in EndlessScroller where it skips the first page (incorrect currentPage count processing)
* [x] Add Progress Bar on image details view
* [x] Custom colors and icons for search and settings
...
Walkthrough for sharing an image: 
